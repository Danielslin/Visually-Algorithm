...
bool MainScene::init()
{
	...
	auto BGMButton = MenuItemImage::create("IMG/MainScene/BGMButton.png", "IMG/MainScene/BGMButtonPushed.png",CC_CALLBACK_1(MainScene::menuCallback, this));
